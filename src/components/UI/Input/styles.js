  ...
  const variants = {
    ...
    cyber: css`
      ...
      &:focus {
        ...
        box-shadow: 0 0 10px ${theme.colors.gradients.cyberpunk.from},
    ...
    rainbow: css`
      ...
      &:focus {
        box-shadow: 0 0 10px rgba(255, 0, 0, 0.2), 0 0 20px rgba(0, 255, 0, 0.2),
...
export const Label = styled.label`
  ...
  top: -0.5rem;
  background: ${({ variant }) =>
    variant === "cyber" ? "#121212" : variant === "neon" ? "#000" : "white"};
  padding: 0 0.5rem;
  font-size: 0.875rem;
  color: ${({ variant, theme }) => {
    switch (variant) {
